...
#Galank = LINE()
Galank = LINE("EtiPRBhFaPKqJtpw3C22.71h34RvD5DrwDQTX4kG8SG.vE2MTAgsxdZ78rqS2Go9N9ekCycrRlpviI2pUMvYvLw")
...
#==============================================================================#
                if text.lower() == 'help':
                    ...
                    Galank.sendContact(to, "uef51f7e2b55de5d45676ab71e0a83cb2")
...
#==============================================================================#
                    ...
                    try:
                        arr = []
                        owner = "uef51f7e2b55de5d45676ab71e0a83cb2"
...
#==============================================================================#
                    ...
                    if op.param1 in cctv['point']:
                        ...
                        if Name in cctv['sidermem'][op.param1]:
                            ...
                            if " " in Name:
                                nick = Name.split(' ')
                                if len(nick) == 2:
                                    Galank.sendMessage(op.param1, "Woii!!!!! " + "☞ " + nick[0] + " ☜" + "\nBocah Ngintip Mulu \nJangan Jangan Nenek Nenek Juga Lu Sikat ")
                                    time.sleep(0.2)
                                    mentionMembers(op.param1,[op.param2])
                                else:
                                    Galank.sendMessage(op.param1, "Hmm Kamu " + "☞" + nick[1] + " ☜" + "\nnNgefans Ya \nSama \nAku ")
                                    time.sleep(0.2)
                                    mentionMembers(op.param1,[op.param2])
                            else:
        ...
        logError(error)
                ...
                elif msg.text.lower().startswith("spaminv "):                	
               	    if 'MENTION' in msg.contentMetadata.keys()!= None:
               		dan = text.split("|")
               		userid = dan[1]
                	namagrup = dan[2]
                	...
                	if jumlah <= 10:
                		for var in range(0,jumlah):
                			try:
                				...
                				sM2(to, "@! sukses spam grup!\n\nkorban: @!\njumlah: {}\nnama grup: {}".format(jumlah, str(namagrup)), [sender, tgb.mid])
                			except Exception as Nigga:
                				line.sendMessage(to, str(Nigga))
                	else:
                		sM2(to, "@! kebanyakan njer!!", [sender])

#sM2 itu def sendMentionV2 nya bang zero, jadi diganti aja.
#==============================================================================#
while True:
    try:
